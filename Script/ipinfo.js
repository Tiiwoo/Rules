...
if (!v4.primaryAddress && !v6.primaryAddress) {
  ...
  $httpClient.get("https://ipinfo.io/json?token=ef76cd420769dc", function (error, response, data) {
    if (error) {
      $done({
...
function loadCarrierNames() {
  ...
  return {
    ...
    '466-01': 'Far EasTone', '466-03': 'Far EasTone',
    '466-97': 'Taiwan Mobile', '466-89': 'Taiwan Star Telecom', '466-05': 'GT',
    // 中国大陆 China
    ...
    '460-15': 'China Broadnet', '460-20': 'China Mobile Tietong',
    // 香港 HongKong
    ...
    '454-01': 'CITIC Telecom International', '454-07': 'UNICOM HK', '454-08': 'Truphone', '454-11': 'CHKTL', '454-23': 'Lycamobile',
    // 日本 Japan
